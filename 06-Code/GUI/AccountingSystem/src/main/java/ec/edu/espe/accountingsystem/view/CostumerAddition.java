 ...
 */
public class CostumerAddition extends javax.swing.JFrame {

    /**
     * Creates new form CostumerAddition
     */
    public CostumerAddition() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CostumerAddition.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CostumerAddition().setVisible(true);
            }
        });
    }
